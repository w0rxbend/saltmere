...
Two closing moves that score points: (1) name the guarantee you actually need — "at-least-once plus [idempotent consumers](/articles/microservices/2026-07-30-idempotency-keys-safe-retries/)" beats chasing [exactly-once](/articles/distributed-systems/2026-08-10-delivery-semantics-exactly-once/) — and (2) note that hybrid is normal: Kafka as the backbone, SQS for one team's work queue, is not an architectural failure.
